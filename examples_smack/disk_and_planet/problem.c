...
void problem_init(int argc, char* argv[]){
	// Setup constants
	N_active = 2; // number of gravitational bodies
	N_tree_fixed = 2; // number of fixed particles in tree
	boxsize = 10;	// AU
	dt = 0.1/0.159; // timestep (years->code units)
	tmax = (1.0e6+1)*dt; // max time
	...
	double spmass = 0.0;         // Superparticle mass (solar masses)
